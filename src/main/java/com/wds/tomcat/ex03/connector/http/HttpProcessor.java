...
//    protected StringManager
    ...
    /**
     * 接收来自传入的HTTP请求的套接字，对每个传入的HTTP请求完成以下4个操作：
     *  创建一个HttpRequest对象
     *  创建一个HttpResponse对象
     *  解析HTTP请求的第1行内容和请求头信息，填充HttpRequest对象
     *  将HttpRequest对象和HttpResponse对象传递给ServletProcessor或StaticResourceProcessor的process方法
     * @param socket
     */
    public void process(Socket socket) {
        ...
        try {
            ...
            response.setHeader("Server", "com.wds.tomcat");
